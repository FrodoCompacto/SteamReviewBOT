...
//		System.out.println("REVIEW: " + review.getReview());
    ...
    public void generateNewDualityPost() throws JSONException, IOException  {
        ...
        postId = fbService.newFacebookPostWDesc(imgService.getInputStream(imgService.genNewDualityImage(Post1, Post2), "jpg"), postComment, desc);
        postRepo.save(new Post(null, review_positive.getReview(), appId, "DUALITY_1_" + postId));
        postRepo.save(new Post(null, review_negative.getReview(), appId, "DUALITY_2_" + postId));
